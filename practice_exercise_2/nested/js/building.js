...
goog.provide('proto.Building.City');
 ...
 * @constructor
 */
proto.Building.City = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.Building.City, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.Building.City.displayName = 'proto.Building.City';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.Building.City.prototype.toObject = function(opt_includeInstance) {
  return proto.Building.City.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.Building.City} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Building.City.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.Building.City}
 */
proto.Building.City.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.Building.City;
  return proto.Building.City.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.Building.City} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.Building.City}
 */
proto.Building.City.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.Building.City.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.Building.City.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.Building.City} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.Building.City.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.Building.City.prototype.getName = function() {
...
/**
 * @param {string} value
 * @return {!proto.Building.City} returns this
 */
proto.Building.City.prototype.setName = function(value) {
 ...
 * @return {string}
 */
proto.Building.City.prototype.getPostcode = function() {
 ...
 * @return {!proto.Building.City} returns this
 */
proto.Building.City.prototype.setPostcode = function(value) {
 ...
 * @return {string}
 */
proto.Building.City.prototype.getCountryName = function() {
 ...
 * @return {!proto.Building.City} returns this
 */
proto.Building.City.prototype.setCountryName = function(value) {
...
proto.Building.Street.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    city: (f = msg.getCity()) && proto.Building.City.toObject(includeInstance, f)
  };
...
proto.Building.Street.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.Building.City;
      reader.readMessage(value,proto.Building.City.deserializeBinaryFromReader);
      msg.setCity(value);
      break;
    default:
      reader.skipField();
...
proto.Building.Street.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.Building.City.serializeBinaryToWriter
    );
  }
};
...
proto.Building.Street.prototype.getCity = function() {
  return /** @type{?proto.Building.City} */ (
    jspb.Message.getWrapperField(this, proto.Building.City, 2));
};


/**
 * @param {?proto.Building.City|undefined} value
 * @return {!proto.Building.Street} returns this
*/
